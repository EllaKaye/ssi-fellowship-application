...
# {.inverse .center .center-h .larger250}
...
[Training (e.g. CSCCE) and mentoring]{.red}
...
[Also use SSI channels to promote the conference, and rainbowR more generally]{.orange}

[Travel to meet with other community of practice leaders]{.yellow}

[Paid training]{.green}

[SSI fellowship mentor]{.blue}

[Opportunities to meet, network, learn from and share experiences with other fellows and SSI members]{.pink}
...
[ellakaye.co.uk]{.larger250 .yellow}
